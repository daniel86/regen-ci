...
#include regen.objects.sprite.getForceMatrix
...
#include regen.objects.sprite.emitQuad_eye
#include regen.camera.camera.transformWorldToEye
...
#include regen.compute.math.rotateXZ
#include regen.compute.math.computeSpritePoints
#include regen.objects.sprite.emitQuad_world
#ifdef USE_FORCE
...
#include regen.objects.sprite.emitBillboard
