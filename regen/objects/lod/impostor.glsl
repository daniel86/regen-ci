...
#include regen.objects.lod.impostor.selectViewIdx.bin
...
-- update.vs
#include regen.objects.lod.impostor.update.defines
...
#include regen.compute.math.computeSpritePoints

#ifdef HAS_windFlow
#include regen.objects.sprite.applyForce
#include regen.objects.sky.wind.windAtPosition
#endif

#define HANDLE_IO(i)

#include regen.objects.lod.impostor.getSpriteSize
#include regen.objects.lod.impostor.getViewIdx
 ...
 **/
-- vs
#include regen.objects.lod.impostor.extrude.vs
-- gs
#include regen.objects.lod.impostor.extrude.gs
-- fs
#include regen.objects.mesh.fs
