...
#include regen.objects.sky.precipitation.update.includes
#include regen.objects.sky.precipitation.isRespawnRequired
#include regen.objects.sky.precipitation.spawnParticle
#include regen.objects.sky.precipitation.updateParticle
...
#ifdef USE_RAIN_DB
#include regen.objects.sky.rain.draw.fs-database
#elif USE_RAIN_DB_RAND
#include regen.objects.sky.rain.draw.fs-database-random
#else
#include regen.objects.sky.rain.draw.fs-single-texture
#endif
...
#include regen.objects.sky.rain.draw.fs-database.input
#include regen.shading.direct.diffuse
#include regen.camera.camera.linearizeDepth
#include regen.objects.particles.sprite.softParticleScale
