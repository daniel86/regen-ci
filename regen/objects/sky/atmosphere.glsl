...
#include regen.objects.sky.utility.computeHorizonExtinction
#include regen.objects.sky.utility.computeEyeExtinction
#include regen.objects.sky.utility.computeAtmosphericDepth
#include regen.objects.sky.utility.computeEyeDepth
#include regen.objects.sky.utility.phase
#include regen.objects.sky.utility.absorb
#ifdef USE_CLOUDS
float sunIntensity() {
