...
#define HAS_ALPHA_CLIP_COEFFICIENTS
    ...
    #include regen.textures.material.defines
    #ifdef HAS_MATERIAL
    #define USE_MATERIAL
    #endif
#endif
...
#ifndef HAS_TESSELATION
    #include regen.textures.textures.mapToVertex
#endif
#ifdef HAS_VERTEX_MASK_MAP
...
#include regen.gl.tesselation.tesselationControl
...
#include regen.gl.tesselation.interpolate
...
#define FS_NO_OUTPUT
#include regen.objects.mesh.fs-shading
    #else
layout(early_fragment_tests) in;
void main() {
...
#include regen.objects.mesh.fs-moments
#endif
...
#endif
#include regen.camera.camera.input
#include regen.textures.material.input
#include regen.shapes.clipping.input
#include regen.textures.textures.input
...
-- writeOutput
#if OUTPUT_TYPE == DEFERRED
#include regen.objects.mesh.writeOutput-deferred
#endif
#if OUTPUT_TYPE == TRANSPARENCY || OUTPUT_TYPE == DIRECT
#include regen.objects.mesh.writeOutput-direct
#endif
#if OUTPUT_TYPE == DEPTH
#define writeOutput(posWorld,norWorld,color)
#endif
#if OUTPUT_TYPE == COLOR
#include regen.objects.mesh.writeOutput-color
#endif

-- writeOutput-color
#include regen.objects.mesh.applyBrightness
#ifdef HAS_ALPHA_CLIP_COEFFICIENTS
#include regen.objects.mesh.clipAlpha
#endif
