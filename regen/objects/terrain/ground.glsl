...
#include regen.colors.color-space
...
------------
-- skirt.vs
#include regen.objects.terrain.ground.vs
-- skirt.fs
#include regen.objects.terrain.ground.fs
...
#include regen.objects.terrain.ground.groundUV
...
#define CUSTOM_FRAGMENT_MAPPING_KEY regen.objects.terrain.ground.fragmentMapping
