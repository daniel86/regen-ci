...
#include regen.objects.mesh.defines
    ...
    #include regen.objects.terrain.water.defines
    #include regen.objects.terrain.water.io.under-water.vs
#endif
...
-- plane.fs
#define IS_WATER_PLANE
#include regen.objects.terrain.water.fs
...
#include regen.textures.textures.texco_planar_reflection
#include regen.compute.math.mat3.inverse
