...
-- position
#include regen.compute.compute.writePosition
...
-- velocity
#include regen.compute.compute.writeVelocity
...
-- modelMatrix
#include regen.compute.compute.readPosition
#include regen.compute.compute.writeModelMatrix

-- writeModelMatrix
#ifndef writeModelMatrix_included
#define2 writeModelMatrix_included
#include regen.compute.math.quaternion.matrix
#include regen.compute.math.quaternion.1
#ifdef HAS_scaleFactor
#include regen.compute.math.mat4.scale
#endif
