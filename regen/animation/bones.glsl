...
#include regen.animation.bones.input
#ifdef USE_BONE_TBO
#include regen.animation.bones.fetchBoneMatrixTBO
#else
#include regen.animation.bones.fetchBoneMatrixArray
#endif // USE_BONE_TBO
...
#include regen.animation.bones.fetchBoneMatrix
