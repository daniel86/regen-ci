...
#include regen.textures.sampling.io
#include regen.textures.sampling.computeTexco
#if TEXTURE_SEMANTICS == DEPTH || TEXTURE_SEMANTICS == SHADOW
#include regen.textures.sampling.writeDepth
#endif
#ifdef DRAW_BORDERS
#include regen.textures.sampling.drawEdges
#endif
...
-- color.fs
#include regen.textures.sampling.fs
...
----------------------------
-- array.color.vs
#include regen.textures.sampling.array.vs
-- array.color.fs
#include regen.textures.sampling.array.fs
...
----------------------------
-- cube.color.vs
#include regen.textures.sampling.cube.vs
-- cube.color.fs
#include regen.textures.sampling.cube.fs
...
uniform sampler2D in_inputTexture;
#include regen.textures.sampling.computeTexco
#include regen.textures.sampling.downsample.depth.average.2x2
