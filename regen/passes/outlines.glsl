...
-- fs
#include regen.passes.outlines.defines
...
#include regen.textures.sampling.computeTexco
    ...
    #include regen.passes.outlines.outline_nor.simple
#endif // OUTLINE_MODE_NORMAL
#ifdef OUTLINE_MODE_DEPTH
    #include regen.passes.outlines.outline_depth.simple
...
#include regen.passes.outlines.outline_depth.defs
...
#include regen.passes.outlines.outline_nor.defs
