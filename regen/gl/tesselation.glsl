...
void offscreenNDC(vec4 v, inout ivec3 offscreen) {
    ...
    #include regen.gl.tesselation.metricSreenDistance
#endif
#if TESS_LOD == EDGE_DEVICE_DISTANCE
    #include regen.gl.tesselation.metricDeviceDistance
#endif
#if TESS_LOD == CAMERA_DISTANCE
    #include regen.gl.tesselation.metricCameraDistance
#endif
#ifdef HAS_HEIGHT_MAP
    #include regen.textures.textures.input
    #include regen.textures.textures.applyHeightMaps
#endif
