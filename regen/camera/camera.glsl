...
#include regen.camera.camera.transformParaboloid
#endif
...
#include regen.camera.camera.input
#ifdef USE_PARABOLOID_PROJECTION
#include regen.camera.camera.transformParaboloidInv
#endif
...
#include regen.camera.camera.input
#ifdef SEPERATE_VIEW_PROJ
#include regen.camera.camera.transformScreenToEye
...
#include regen.camera.camera.input
#include regen.camera.camera.transformTexcoToScreen
#include regen.camera.camera.transformScreenToEye
...
#include regen.camera.camera.input
#include regen.camera.camera.transformTexcoToScreen
#include regen.camera.camera.transformScreenToWorld
